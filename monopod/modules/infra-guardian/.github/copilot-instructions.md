...
## Project Overview
**Module**: Infra-Guardian  
**Tech Stack**: Python, Azure Policy, Azure Functions, Terraform  
**Domain**: Infrastructure / DevOps

---

## Purpose
Self-healing infrastructure with Azure Policy and automated remediation

---

## Technology Stack
Python, Azure Policy, Azure Functions, Terraform
...
When generating code for infra-guardian:
