...
## Project Overview
**Module**: Healthcare PWA  
**Tech Stack**: React, TypeScript, PouchDB, CouchDB, Service Workers  
**Domain**: Healthcare / Medical Records

---

## Purpose
Progressive Web App for patient records with offline-first capabilities

---

## Technology Stack
React, TypeScript, PouchDB, CouchDB, Service Workers
...
When generating code for healthcare:
