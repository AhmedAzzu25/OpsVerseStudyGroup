# GitHub Copilot Instructions - Logistics & Fleet

## Project Overview
**Module**: Logistics & Fleet  
**Tech Stack**: TypeScript, Azure IoT Hub, Digital Twins, SignalR, Azure Maps  
**Domain**: Logistics / Transportation

---

## Purpose
Fleet management with IoT Hub and Digital Twins
...
When generating code for logistics:
