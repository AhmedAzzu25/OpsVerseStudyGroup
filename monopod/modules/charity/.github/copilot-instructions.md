# GitHub Copilot Instructions - Charity Management

## Project Overview
**Module**: Charity Management  
**Tech Stack**: .NET 8, SQL Ledger, Twilio WhatsApp API, Azure Functions  
**Domain**: Non-Profit / Charity

---

## Purpose
Transparent donation tracking with SQL Ledger and WhatsApp Bot

---

## Technology Stack
.NET 8, SQL Ledger, Twilio WhatsApp API, Azure Functions
...
When generating code for charity:
